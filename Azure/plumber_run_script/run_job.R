...
# titles
x = sample(
    c("Resources", "Ideas", "Chapter", "Interaction","Complexity",
    ...
    1)
y = sample(
    c("Maintenance","Fun", "#People","Entertainment","Effort",
...
# color settings
color_ = sample(
    c("#30445b", "#32305b","#30595b"),
    1)
background_color= sample(c("#ffffe6","#FFCC99", "#ffe5e5" ,"#e5ffe5","#e5e5ff"),1)
log_info(glue("using \"{title}\" with foreground: {color_} and background: {background_color}"))
